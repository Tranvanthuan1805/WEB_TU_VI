...
import { CheckCircle, AlertTriangle, XCircle, Clock, ChevronRight, Copy, Check } from 'lucide-react';
...
function VnpayReturnContent() {
  ...
  useEffect(() => {
    ...
    const clearPolling = startPolling(txnRef);
    return () => clearPolling();
      ...
      <div className="bg-white border border-[#E5DDD0]/70 rounded-3xl p-6 md:p-10 shadow-md text-center space-y-6">
        ...
        {paymentState === "Failed" && (
          <div className="bg-red-50/50 border border-red-200 rounded-2xl p-8 space-y-4">
            ...
            <div className="pt-4">
              <Link href="/san-pham" className="text-xs font-bold text-[#C5A059] hover:underline uppercase tracking-wider">
...
export default function VnpayReturn() {
  return (
    <Suspense fallback={<div className="text-center py-20">Đang xác nhận kết quả thanh toán...</div>}>
      <VnpayReturnContent />
    </Suspense>
  );
}
