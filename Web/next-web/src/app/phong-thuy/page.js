...
import { Compass, RefreshCw, Search, X } from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
      ...
      {activeTab === "hexagrams" && (
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          {/* Details Sidebar */}
          {selectedHex && (
            <div className="lg:col-span-6 bg-white border border-[#E5DDD0]/70 rounded-3xl p-6 md:p-8 space-y-6 shadow-md relative sticky top-24">
              <button
                type="button"
