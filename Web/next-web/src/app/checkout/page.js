  ...
  if (error || !product) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center space-y-4">
        ...
        <Link href="/san-pham" className="inline-flex items-center gap-1.5 text-sm text-[#C5A059] font-bold hover:underline">
...
export default function Checkout() {
  return (
    <Suspense fallback={<div className="text-center py-20">Đang tải thông tin đơn hàng...</div>}>
      <CheckoutContent />
    </Suspense>
  );
}
