...
This project is indexed by GitNexus as **Project-2026** (6993 symbols, 21762 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
