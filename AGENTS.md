...
This project is indexed by GitNexus as **Project-2026** (6937 symbols, 21630 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
